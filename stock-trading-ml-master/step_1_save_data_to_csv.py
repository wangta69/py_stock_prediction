...
if __name__ == "__main__":
    ...
    parser.add_argument('--symbol', default="MSFT", type=str, help="the stock symbol you want to download")
    parser.add_argument('--time_window', default="daily", type=str, choices=[
